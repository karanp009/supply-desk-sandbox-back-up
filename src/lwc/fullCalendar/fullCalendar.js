...
// import getAvailbilityDetails from '@salesforce/apex/ts_schedulercontroller.getAvailbilityDetails';
...
//   }
  ...
  initialiseFullCalendarJs() {
    ...
    $(ele).fullCalendar({
      ...
      //   console.log({ info });
      //   let dateObj = new Date(info.start);
      //   console.log(dateObj.getFullYear());
      //   console.log(dateObj.getMonth());
      //   this.calandereventdragged(event);
      // },
      eventDrop: function (info) {
        
        let id = info.id;
        console.log(id);
        console.log(typeof info.start);
        let dateObj = new Date(info.start);
        ...
        let paddedDate = dateObj.toString();
        ...
        let tostoreData = `${year} - ${paddedMonth} - ${paddedDate}`;
        console.log(tostoreData);
      },
  ...
  //! add the logic to support multiple input texts
  handleKeyup = event => {
